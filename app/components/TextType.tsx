...
const TextType: React.FC<TextTypeProps> = ({
  ...
  const blinkInterval = useRef<ReturnType<typeof setInterval>>(null);
  ...
  useEffect(() => {
    ...
    return () => { if (blinkInterval.current) clearInterval(blinkInterval.current); };
  ...
  return createElement(
    Component,
    {
      ...
      style: { display: 'inline-block', whiteSpace: 'pre-wrap', ...(props.style || {}) },
    },
