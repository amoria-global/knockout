...
export interface WalletDTO {
  ...
  balanceTips: number;
  balanceBonuses: number;
  balanceGifts: number;
  balanceStreamFees: number;
  balanceDonations: number;
  heldForDelivery: number;
...
/**
 * Spring Data Page shape (matches Jackson serialization of org.springframework.data.domain.Page).
 */
